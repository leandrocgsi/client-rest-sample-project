package br.com.semeru.communication;
...
public class Communication<T extends BaseBean> implements ICommunication<T> {
     ...
     *
     *
     * @param path Esse parâmetro deve receber uma String contendo o path de
     * acesso ao serviÃ§o desejado Ex: "service/cidade/save"
     * @param mediaType Esse parâmetro deve receber o MimeType a ser usado na
     * comunicação Ex: "Application/JSON"
     * @param bean Esse parâmetro deve receber uma instância do objeto a ser
     * persistido Ex: Cidade cidade
     */
     ...
     *
     * @param path Esse parâmetro deve receber uma String contendo o path de
     * acesso ao serviÃ§o desejado Ex: "service/cidade/update"
     * @param mediaType Esse parâmetro deve receber o MimeType a ser usado na
     * comunicação Ex: "Application/JSON"
     * @param bean Esse parâmetro deve receber uma instância do objeto a ser
     * persistido Ex: Cidade cidade
     ...
     *
     * @param path Esse parâmetro deve receber uma String contendo o path de
     * acesso ao serviÃ§o desejado Ex: "service/cidade/delete/{id}"
    ...
    /**
     * Este método é responsável por localizar uma informação no servidor a
     * partir de um id
     *
     *
     * @param path Esse parâmetro deve receber uma String contendo o path de
     * acesso ao serviÃ§o desejado Ex: "service/cidade/findbyid/{id}"
     * @param id Esse parâmetro deve receber o id do objeto a ser deletado
     * @param mediaType Esse parâmetro deve receber o MimeType a ser usado na
     * comunicação Ex: "Application/JSON"
     */
